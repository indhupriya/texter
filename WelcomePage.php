          ...
          <div class="col-sm-9 col-md-9 templatemo_col9">
            ...
            <nav class="mainMenu">
              <ul class="nav">
                ...
                <li><a class="menu" href="#templatemo_about">Login</a></li>
      	...
      	<div  id="slider"  class="nivoSlider templatemo_slider">
            ...
            <a href="#"><img src="images/slider/img_3_blank.jpg" alt="slide 3" /></a> 	        	
             ...
             <div class="templatemo_caption">
                    ...
                    <div class="clear"></div>
             		<p><h3>Texter is a blogging site where users can blog and read other user blogs.</h3></p>
	          	    <a class="btn btn-large btn-primary" href="#">Start Blogging!</a>
              </div>  
  </header>
